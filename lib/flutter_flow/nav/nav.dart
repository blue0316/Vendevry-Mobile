...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : ChooseAuthPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'ChooseAuthPage',
          path: '/chooseAuthPage',
          builder: (context, params) => ChooseAuthPageWidget(),
        ),
        FFRoute(
          name: 'ChooseLoginPage',
          path: '/chooseLoginPage',
          builder: (context, params) => ChooseLoginPageWidget(),
        ),
        FFRoute(
          name: 'LoginPage',
          path: '/loginPage',
          builder: (context, params) => LoginPageWidget(
            userRole: params.getParam<UserRole>('userRole', ParamType.Enum),
          ),
        ),
        FFRoute(
          name: 'OnboardPagePage',
          path: '/onboardPagePage',
          builder: (context, params) => OnboardPagePageWidget(),
        ),
        FFRoute(
          name: 'VendorDashboardPage',
          path: '/vendorDashboardPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'VendorDashboardPage')
              : VendorDashboardPageWidget(),
        ),
        FFRoute(
          name: 'ChooseRegisterPage',
          path: '/chooseRegisterPage',
          builder: (context, params) => ChooseRegisterPageWidget(),
        ),
        FFRoute(
          name: 'SignUpPage',
          path: '/signUpPage',
          builder: (context, params) => SignUpPageWidget(
            userType: params.getParam<UserRole>('userType', ParamType.Enum),
          ),
        ),
        FFRoute(
          name: 'CreateAccount5',
        ...
        FFRoute(
          ...
          path: '/termsAgreementPage',
          builder: (context, params) => TermsAgreementPageWidget(
            userType: params.getParam<UserRole>('userType', ParamType.Enum),
          ),
        ),
        FFRoute(
          name: 'AddProductPageOne',
          path: '/addProductPageOne',
          builder: (context, params) => AddProductPageOneWidget(),
        ),
        FFRoute(
          name: 'VendorLikesPage',
          path: '/vendorLikesPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'VendorLikesPage')
              : VendorLikesPageWidget(),
        ),
        FFRoute(
          name: 'VendorCartPage',
          path: '/vendorCartPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'VendorCartPage')
              : VendorCartPageWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          ...
          builder: (context, params) => SingleProductPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'AddServicePageOne',
          path: '/addServicePageOne',
          builder: (context, params) => AddServicePageOneWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/productBoostPage',
          builder: (context, params) => ProductBoostPageWidget(),
        ),
        FFRoute(
          name: 'ServiceDashboard',
          path: '/serviceDashboard',
          builder: (context, params) => ServiceDashboardWidget(),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/initialSplash.png',
                    fit: BoxFit.fill,
                  ),
                )
              : page;
