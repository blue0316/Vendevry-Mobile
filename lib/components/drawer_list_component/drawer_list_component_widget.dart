...
import 'drawer_list_component_model.dart';
export 'drawer_list_component_model.dart';

class DrawerListComponentWidget extends StatefulWidget {
  const DrawerListComponentWidget({super.key});

  @override
  State<DrawerListComponentWidget> createState() =>
      _DrawerListComponentWidgetState();
}

class _DrawerListComponentWidgetState extends State<DrawerListComponentWidget> {
  late DrawerListComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DrawerListComponentModel());
  }
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (currentUserDocument?.role == UserRole.VENDOR)
                          AuthUserStreamWidget(
                            builder: (context) => Row(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  Padding(
                    ...
                    child: MouseRegion(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: _model.mouseRegionHovered27!
                      ...
                      onEnter: ((event) async {
                        ...
                        context.goNamedAuth('ChooseAuthPage', context.mounted);
                      }),
                      onExit: ((event) async {
