...
import 'choose_register_page_model.dart';
export 'choose_register_page_model.dart';

class ChooseRegisterPageWidget extends StatefulWidget {
  const ChooseRegisterPageWidget({super.key});

  @override
  State<ChooseRegisterPageWidget> createState() =>
      _ChooseRegisterPageWidgetState();
}

class _ChooseRegisterPageWidgetState extends State<ChooseRegisterPageWidget> {
  late ChooseRegisterPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseRegisterPageModel());
  }
